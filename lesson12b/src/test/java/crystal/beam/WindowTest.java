...
public class WindowTest implements Serializable {
  ...
  public void should_construct_fixed_time_window() {
    ...
    PCollection<String> timestampedLetters = pipeline.apply(Create.timestamped(Arrays.asList(
        TimestampedValue.of("a1", new Instant(0)),
        ...
        TimestampedValue.of("a6", new Instant(1)),
        TimestampedValue.of("d1", new Instant(4)),
        TimestampedValue.of("d2", new Instant(4)),
        TimestampedValue.of("a5", new Instant(1))
    )));
    ...
    assertThat(itemsInstant0).hasSize(1).containsOnly("a1");


    List<String> itemsInstant1 = itemsPerWindow.get(new Instant(1));
    assertThat(itemsInstant1).hasSize(5).containsOnly( "a2", "a3", "a4", "a5", "a6");
...
enum WindowHandlers {
  ...
  FIXED_TIME, SLIDING_TIME_DUPLICATED;
